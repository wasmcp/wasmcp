...
pub struct CompositionPackages {
    ...
    pub oauth_auth_id: wac_graph::PackageId,
...
pub fn load_and_register_components(
    ...
    let oauth_auth_pkg = load_package(graph, "oauth-auth", oauth_auth_path, verbose)?;
    ...
    let oauth_auth_id = graph.register_package(oauth_auth_pkg)?;
