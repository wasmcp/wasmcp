...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:rust-helpers:handler@0.1.0:tools-handler:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 3464] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x84\x1a\x01A\x02\x01\
...
\x0d\x04\0\"fastertools:mcp/tool-handler@0.1.1\x05\x11\x04\0(rust-helpers:handle\
r/tools-handler@0.1.0\x04\0\x0b\x13\x01\0\x0dtools-handler\x03\0\0\0G\x09produce\
