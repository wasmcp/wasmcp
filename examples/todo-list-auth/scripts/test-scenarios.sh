...
echo "==================================================================="
echo ""
echo "Authorization Patterns Demonstrated:"
echo ""
echo "1. ${GREEN}Scope-Based Access Control${NC}"
...
echo ""
echo "2. ${GREEN}Role-Based Access Control (RBAC)${NC}"
echo "   • role=admin claim required for delete operations (remove_item, clear_all)"
echo "   • Other roles (viewer, analyst) cannot delete items"
echo ""
echo "3. ${GREEN}Attribute-Based Access Control (ABAC)${NC}"
echo "   • allowed_tools claim provides fine-grained tool-level permissions"
echo "   • If present, only tools in the list are allowed"
echo "   • If absent, all tools allowed (default behavior)"
echo ""
echo "==================================================================="
echo ""
