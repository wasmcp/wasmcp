    ...
    pub mod wasmcp {
        pub mod mcp {
            ...
            pub mod handler {
                ...
                #[doc(hidden)]
                macro_rules! __export_wasmcp_mcp_handler_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "wasmcp:mcp/handler#list-tools")] unsafe extern "C" fn
                        export_list_tools() -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_list_tools_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_wasmcp:mcp/handler#list-tools")] unsafe extern "C" fn
                        _post_return_list_tools(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_list_tools::<$ty > (arg0) } }
                        #[unsafe (export_name = "wasmcp:mcp/handler#call-tool")] unsafe
                        ...
                        "cabi_post_wasmcp:mcp/handler#call-tool")] unsafe extern "C" fn
                        _post_return_call_tool(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_call_tool::<$ty > (arg0) } }
                        #[unsafe (export_name = "wasmcp:mcp/handler#list-resources")]
                        unsafe extern "C" fn export_list_resources() -> * mut u8 { unsafe
                        { $($path_to_types)*:: _export_list_resources_cabi::<$ty > () } }
                        #[unsafe (export_name =
                        "cabi_post_wasmcp:mcp/handler#list-resources")] unsafe extern "C"
                        fn _post_return_list_resources(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_list_resources::<$ty > (arg0)
                        } } #[unsafe (export_name = "wasmcp:mcp/handler#read-resource")]
                        unsafe extern "C" fn export_read_resource(arg0 : * mut u8, arg1 :
                        usize,) -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_read_resource_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name = "cabi_post_wasmcp:mcp/handler#read-resource")]
                        unsafe extern "C" fn _post_return_read_resource(arg0 : * mut u8,)
                        { unsafe { $($path_to_types)*:: __post_return_read_resource::<$ty
                        > (arg0) } } #[unsafe (export_name =
                        "wasmcp:mcp/handler#list-prompts")] unsafe extern "C" fn
                        export_list_prompts() -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_list_prompts_cabi::<$ty > () } } #[unsafe (export_name =
                        "cabi_post_wasmcp:mcp/handler#list-prompts")] unsafe extern "C"
                        fn _post_return_list_prompts(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_list_prompts::<$ty > (arg0) }
                        } #[unsafe (export_name = "wasmcp:mcp/handler#get-prompt")]
                        ...
                        arg2, arg3) } } #[unsafe (export_name =
                        "cabi_post_wasmcp:mcp/handler#get-prompt")] unsafe extern "C" fn
                        _post_return_get_prompt(arg0 : * mut u8,) { unsafe {
                        $($path_to_types)*:: __post_return_get_prompt::<$ty > (arg0) } }
                        };
                    };
                }
                #[doc(hidden)]
                pub(crate) use __export_wasmcp_mcp_handler_cabi;
...
macro_rules! __export_handler_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasmcp::mcp::handler::__export_wasmcp_mcp_handler_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:auth-demo:handler:handler:encoded world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 756] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf6\x04\x01A\x02\x01\
...
t-prompt\x01\x1f\x04\0\x12wasmcp:mcp/handler\x05\0\x04\0\x19auth-demo:handler/ha\
ndler\x04\0\x0b\x0d\x01\0\x07handler\x03\0\0\0G\x09producers\x01\x0cprocessed-by\
