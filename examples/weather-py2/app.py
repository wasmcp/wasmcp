...
try:
    ...
    # Not running in Wasm environment - for IDE support
    poll_loop = None
    PollLoop = None
    Stream = None
...
class WeatherMCPCapabilities(ToolsCapabilities, CoreCapabilities):
    ...
    def handle_initialize(self, request: core_types.InitializeRequest) -> core_types.InitializeResponse:
    ...
    def handle_list_tools(self, request: tool_types.ListToolsRequest) -> tool_types.ListToolsResponse:
        """Return the list of available tools."""
        tools = []
        
        for name, metadata in self.TOOLS.items():
            tools.append(tool_types.Tool(
        ...
        return tool_types.ListToolsResponse(
            tools=tools,
            next_cursor=None,
            meta=None
        )
