...
/// Per-task state for the current stdio message.
///
...
pub struct TaskState {
    /// The output stream for writing the message response
...
/// Initialize task state at the start of a new message.
///
/// Must be called before any handlers access the state.
///
/// # Preview 2 Implementation
///
/// Resets the thread-local state for the new message.
///
/// # Preview 3 Implementation (Future)
///
...
/// Clean up task state at the end of a message.
///
/// Should be called when the message processing completes to free resources.
///
/// # Preview 2 Implementation
///
