            ...
            pub mod error_result {
                ...
                pub unsafe fn _export_write_cabi<T: Guest>(
                    ...
                    let result4 = T::write(
                        ...
                        super::super::super::super::wasmcp::mcp::error::Error {
                            code: super::super::super::super::wasmcp::mcp::error::ErrorCode::_lift(
                                arg4 as u8,
                            ),
                            message: _rt::string_lift(bytes2),
                            data: match arg7 {
                                0 => None,
                                1 => {
                                    let e = {
                    ...
                    match result4 {
                        ...
                        Err(e) => {
                            *ptr5.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::wasi::io::streams::StreamError as V6;
                            match e {
                                V6::LastOperationFailed(e) => {
                                    *ptr5.add(4).cast::<u8>() = (0i32) as u8;
                                    *ptr5.add(8).cast::<i32>() = (e).take_handle() as i32;
                                }
                                V6::Closed => {
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_error_writer_impl {
    ($ty:ident) => {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:wasmcp:mcp@0.3.0-alpha.59:error-writer:encoded world"
)]
#[doc(hidden)]
