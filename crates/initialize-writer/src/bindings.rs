            ...
            pub mod initialize_result {
                ...
                pub unsafe fn _export_write_cabi<T: Guest>(arg0: *mut u8) -> *mut u8 {
                    ...
                    let result34 = T::write(
                        ...
                        InitializeResult {
                            server_info: super::super::super::super::wasmcp::mcp::types::Implementation {
                                ...
                                version: _rt::string_lift(bytes16),
                            },
                            capabilities: super::super::super::super::wasmcp::mcp::types::ServerCapabilities::empty()
                                | super::super::super::super::wasmcp::mcp::types::ServerCapabilities::from_bits_retain(
                                    ((l17 as u8) << 0) as _,
                                ),
                            protocol_version: super::super::super::super::wasmcp::mcp::types::ProtocolVersion::_lift(
                                l18 as u8,
                            ),
                            options: match l19 {
                                0 => None,
                    ...
                    match result34 {
                        ...
                        Err(e) => {
                            *ptr35.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::wasi::io::streams::StreamError as V36;
                            match e {
                                V36::LastOperationFailed(e) => {
                                    *ptr35.add(4).cast::<u8>() = (0i32) as u8;
                                    *ptr35.add(8).cast::<i32>() = (e).take_handle() as i32;
                                }
                                V36::Closed => {
                                    *ptr35.add(4).cast::<u8>() = (1i32) as u8;
                                }
                            }
                        }
                    };
...
#[allow(unused_macros)]
#[doc(hidden)]
macro_rules! __export_initialize_writer_impl {
    ($ty:ident) => {
