...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.41.0:wasmcp:spin-authkit:mcp-spin-authkit:encoded world"
)]
#[doc(hidden)]
...
t-prompt\x01\x1f\x03\0\x12wasmcp:mcp/handler\x05\0\x04\0$wasmcp:spin-authkit/mcp\
-spin-authkit\x04\0\x0b\x16\x01\0\x10mcp-spin-authkit\x03\0\0\0G\x09producers\x01\
