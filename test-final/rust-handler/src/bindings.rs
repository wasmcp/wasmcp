    ...
    pub mod wasmcp {
        pub mod mcp {
            ...
            pub mod handler {
                ...
                pub type Tool = super::super::super::super::wasmcp::mcp::types::Tool;
                pub type ToolResult = super::super::super::super::wasmcp::mcp::types::ToolResult;
                pub type ResourceInfo = super::super::super::super::wasmcp::mcp::types::ResourceInfo;
                pub type ResourceResult = super::super::super::super::wasmcp::mcp::types::ResourceResult;
                pub type PromptDescriptor = super::super::super::super::wasmcp::mcp::types::PromptDescriptor;
                pub type PromptResult = super::super::super::super::wasmcp::mcp::types::PromptResult;
                #[doc(hidden)]
                ...
                pub unsafe fn _export_list_tools_cabi<T: Guest>() -> *mut u8 {
                    ...
                    for (i, e) in vec6.into_iter().enumerate() {
                        ...
                        {
                            let super::super::super::super::wasmcp::mcp::types::Tool {
                                name: name2,
                ...
                pub unsafe fn _export_call_tool_cabi<T: Guest>(
                    ...
                    use super::super::super::super::wasmcp::mcp::types::ToolResult as V8;
                    match result2 {
                        V8::Text(e) => {
                        ...
                        V8::Error(e) => {
                            *ptr3.add(0).cast::<u8>() = (1i32) as u8;
                            let super::super::super::super::wasmcp::mcp::types::Error {
                                code: code5,
                                message: message5,
                                data: data5,
                            } = e;
                ...
                pub unsafe fn _export_list_resources_cabi<T: Guest>() -> *mut u8 {
                    ...
                    for (i, e) in vec7.into_iter().enumerate() {
                        ...
                        {
                            let super::super::super::super::wasmcp::mcp::types::ResourceInfo {
                                uri: uri2,
                                name: name2,
                                description: description2,
                ...
                pub unsafe fn _export_read_resource_cabi<T: Guest>(
                    ...
                    use super::super::super::super::wasmcp::mcp::types::ResourceResult as V11;
                    match result1 {
                        V11::Contents(e) => {
                            *ptr2.add(0).cast::<u8>() = (0i32) as u8;
                            let super::super::super::super::wasmcp::mcp::types::ResourceContents {
                                uri: uri3,
                ...
                pub unsafe fn _export_list_prompts_cabi<T: Guest>() -> *mut u8 {
                    ...
                    for (i, e) in vec9.into_iter().enumerate() {
                        ...
                        {
                            let super::super::super::super::wasmcp::mcp::types::PromptDescriptor {
                                name: name2,
                                description: description2,
                            ...
                            *base.add(0).cast::<*mut u8>() = ptr3.cast_mut();
                            ...
                            for (i, e) in vec8.into_iter().enumerate() {
                                let base = result8
                                    .add(i * (6 * ::core::mem::size_of::<*const u8>()));
                                {
                                    let super::super::super::super::wasmcp::mcp::types::PromptArgument {
                                        name: name5,
                ...
                pub unsafe fn _export_get_prompt_cabi<T: Guest>(
                    ...
                    let ptr3 = (&raw mut _RET_AREA.0).cast::<u8>();
                    use super::super::super::super::wasmcp::mcp::types::PromptResult as V11;
                    match result2 {
                        V11::Messages(e) => {
                            *ptr3.add(0).cast::<u8>() = (0i32) as u8;
                            let vec7 = e;
                            ...
                            for (i, e) in vec7.into_iter().enumerate() {
                                ...
                                {
                                    let super::super::super::super::wasmcp::mcp::types::PromptMessage {
                                        role: role4,
                                        content: content4,
                                    } = e;
                ...
                pub trait Guest {
                    ...
                    fn read_resource(uri: _rt::String) -> ResourceResult;
                    /// List available prompts - synchronous
                    fn list_prompts() -> _rt::Vec<PromptDescriptor>;
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 1128] = *b"\
...
ntss\0\x0b\x04\0\x0aget-prompt\x01\x14\x04\0\x18wasmcp:mcp/handler@0.1.0\x05\x07\
\x04\0\x1cwasmcp:mcp/mcp-handler@0.1.0\x04\0\x0b\x11\x01\0\x0bmcp-handler\x03\0\0\
